<div class="px-8 pt-4 mx-auto mt-12 border border-green-700 sm:w-min ">
    <div class="max-w-xl mx-auto">
        ...
        <div class="mt-2">
            <form action="">
                <div>
                    <input type="text" class="w-full" placeholder="Enter Teamname">
                ...
                <div class="flex w-full">
                    <div>
                        <input type="text" class="w-full mt-4" placeholder="Enter Clantag ">
                    ...
                    <div class="self-center w-full text-gray-700 mt-7">
                        <div class="w-full text-right">
                            ...
                            <input type="checkbox" value="bw" checked class="ml-2"><span class="ml-1">Broodwar</span>
